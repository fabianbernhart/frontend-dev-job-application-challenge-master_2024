...
const tshirtColor = computed(() => {
    if (designStore.color) {
        return designStore.color.color
    }
})

const st0Color = ref('#fff')
const st1Color = ref('red')
const st2Color = ref('red')
const st3Color = ref('red')
</script>
